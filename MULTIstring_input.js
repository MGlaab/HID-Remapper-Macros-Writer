...
const data = fs.readFileSync(json_in_path);

// parsing the JSON object
// to convert it to a JavaScript object
const data_file = JSON.parse(data);
// console.log(data_file["macros"])

function magic(input_string, macro_number) {
  ...
  console.log("Macro " + macro_number + " was written.")
  // console.log(result_array)
  // console.log(data_file['macros'][macro_number])
  data_file['macros'][macro_number].push(...result_array)
  console.log(data_file['macros'])
  // result_array.length = 0
  // console.log(result_array)

  const datastr = JSON.stringify(data_file, null, 4);
  console.log(datastr)
  // writing the JSON string content to a file
  fs.writeFile(json_out_path, datastr,
    {
      flag: "r+",
    },
    (err) => {
  ...
  // fs.writeFile(json_out_path, data_file,
  //   {
  //     flag: "r+",
  //   },
  //   (err) => {
