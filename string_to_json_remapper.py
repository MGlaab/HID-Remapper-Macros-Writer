...
json_in_path = 'base hid-remapper-config.json'
json_out_path = 'base modified.json'


input_string = 'I am the GREATEST in the WORLD !'
string_list = []
usages_list =[]
...
#
# mac_list = split_list(usages_list, 1)
# print(mac_list)
# read the json file convert it to a python dictionary
with open(json_in_path) as f:
   data = json.load(f)

data['macros'][-1] = result
